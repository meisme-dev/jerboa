...
fun monochrome(): Pair<ColorScheme, ColorScheme> {
    ...
    val md_theme_dark_secondary = Color(0xffefefef)
    val md_theme_dark_onSecondary = Color(0xff000000)
    val md_theme_dark_secondaryContainer = Color(0xffefefef)
    val md_theme_dark_onSecondaryContainer = Color(0xff000000)
    val md_theme_dark_tertiary = Color(0xffbababa)
    val md_theme_dark_onTertiary = Color(0xff000000)
    val md_theme_dark_tertiaryContainer = Color(0xffbababa)
...
val Color.darker @Composable get() = Color((this.red * 0.75).toFloat(),
    (this.green * 0.75).toFloat(), (this.blue * 0.75).toFloat(), this.alpha, this.colorSpace)
